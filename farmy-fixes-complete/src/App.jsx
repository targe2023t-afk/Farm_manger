...
export default function App() {
  ...
  const [users,setUsers]         = useState(()=>ld("users",[
    {id:"00000000-0000-0000-0000-000000000001",username:"admin",password:"1234",role:"admin",name:"المدير العام",phone:"",status:"active"},
    {id:"00000000-0000-0000-0000-000000000002",username:"ahmed",password:"1234",role:"manager",name:"أحمد محمد",phone:"",status:"active",createdBy:"00000000-0000-0000-0000-000000000001",permissions:defPerms()},
  ]));
